...
type AdminTemplateExerciseType = {
  id?: string;
  templateId?: string;
...
export const exerciseTemplates: AdminTemplateExerciseType[] = [
...
export const exerciseWorkouts: AdminWorkoutExerciseType[] = [
  { movementId: '1', name: '槓鈴臥推', sets: [], exerciseCategory: '胸', iconSrc:"/action-imgs/chest/chest_Barbell-Bench-Press.png" },
  { movementId: '2', name: '啞鈴臥推', sets: [], exerciseCategory: '胸', iconSrc:"/action-imgs/chest/chest_dumbbell-press.png" },
  { movementId: '3', name: '上斜啞鈴臥推', sets: [], exerciseCategory: '胸', iconSrc:"/action-imgs/chest/chest_Incline-Dumbbell-Press.png" },
  { movementId: '4', name: '飛鳥夾胸', sets: [], exerciseCategory: '胸', iconSrc:"/action-imgs/chest/chest_pec-deck-fly.png" },
  { movementId: '5', name: '上斜臥推機', sets: [], exerciseCategory: '胸', iconSrc:"/action-imgs//chest/chest_Lever-Incline-Chest-Press.png" },
  { movementId: '6', name: '坐姿胸推', sets: [], exerciseCategory: '胸', iconSrc:"/action-imgs//chest/chest_Inner-Chest-Press-Machine.png" },
  { movementId: '7', name: '滑輪下拉', sets: [], exerciseCategory: '背', iconSrc:"/action-imgs/back/back_Lat-Pulldown.png" },
  { movementId: '8', name: '坐姿划船', sets: [], exerciseCategory: '背', iconSrc:"/action-imgs/back/back_Seated-Cable-Row.png" },
  { movementId: '9', name: '器械划船', sets: [], exerciseCategory: '背', iconSrc:"/action-imgs/back/back_Plate-Loaded-Seated-Row.png" },
  { movementId: '10', name: '槓桿高划船', sets: [], exerciseCategory: '背', iconSrc:"/action-imgs/back/back_Lever-High-Row.png" },
  { movementId: '11', name: '直背下拉', sets: [], exerciseCategory: '背', iconSrc:"/action-imgs/back/back_Rope-Straight-Arm-Pulldown.png" },
  { movementId: '12', name: '輔助引體向上', sets: [], exerciseCategory: '背', iconSrc:"/action-imgs/back/back_Assisted-Pull-up.png" },
  { movementId: '13', name: '肩推', sets: [], exerciseCategory: '肩', iconSrc:"/action-imgs/shoulder/shoulder_Dumbbell-Shoulder-Press.png" },
  { movementId: '14', name: '側平舉', sets: [], exerciseCategory: '肩', iconSrc:"/action-imgs/shoulder/shoulder_Dumbbell-Lateral-Raise.png" },
  { movementId: '15', name: '前平舉', sets: [], exerciseCategory: '肩', iconSrc:"/action-imgs/shoulder/shoulder_Alternating-Dumbbell-Front-Raise.png" },
  { movementId: '16', name: '坐姿飛鳥', sets: [], exerciseCategory: '肩', iconSrc:"/action-imgs/shoulder/shoulder_Seated-Rear-Lateral-Dumbbell-Raise.png" },
  { movementId: '17', name: '面拉', sets: [], exerciseCategory: '肩', iconSrc:"/action-imgs/shoulder/shoulder_Face-Pull.png" },
  { movementId: '18', name: '器械側平舉', sets: [], exerciseCategory: '肩', iconSrc:"/action-imgs/shoulder/shoulder_Lateral-Raise-Machine.png" },
  { movementId: '19', name: '器械肩推', sets: [], exerciseCategory: '肩', iconSrc:"/action-imgs/shoulder/shoulder_Lever-Shoulder-Press.png" },
  { movementId: '20', name: '反向飛鳥', sets: [], exerciseCategory: '肩', iconSrc:"/action-imgs/shoulder/shoulder_Rear-Delt-Machine-Flys.png" },
  { movementId: '21', name: '深蹲', sets: [], exerciseCategory: '腿', iconSrc:"/action-imgs/leg/leg_BARBELL-SQUAT.png" },
  { movementId: '22', name: '史密斯深蹲', sets: [], exerciseCategory: '腿', iconSrc:"/action-imgs/leg/leg_smith-machine-squat.png" },
  { movementId: '23', name: '反向哈克深蹲', sets: [], exerciseCategory: '腿', iconSrc:"/action-imgs/leg/leg_Reverse-Hack-Squat.png" },
  { movementId: '24', name: '羅馬硬舉', sets: [], exerciseCategory: '腿', iconSrc:"/action-imgs/leg/leg_Barbell-Romanian-Deadlift.png" },
  { movementId: '25', name: '腿推', sets: [], exerciseCategory: '腿', iconSrc:"/action-imgs/leg/leg_Leg-Press.png" },
  { movementId: '26', name: '立式跪腿彎舉', sets: [], exerciseCategory: '腿', iconSrc:"/action-imgs/leg/leg_Lever-Kneeling-Leg-Curl.png" },
  { movementId: '27', name: '雙腿伸屈', sets: [], exerciseCategory: '腿', iconSrc:"/action-imgs/leg/leg_LEG-EXTENSION.png" },
  { movementId: '28', name: '大腿內收外展訓練', sets: [], exerciseCategory: '腿', iconSrc:"/action-imgs/leg/leg_HiP-ABDUCTION-MACHINE.png" },
];
