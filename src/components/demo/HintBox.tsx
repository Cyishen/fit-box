...
const HintBox = () => {
  return (
    <div className="flex h-[500px] justify-center px-3 py-12">
    ...
    >
      ...
      <AnimatePresence>
        {showFlyout && (
          ...
          >
            {/* <div className="absolute -top-6 left-0 right-0 h-6 bg-blue-300" /> */}
...
const PricingContent = () => {
  return (
    <div className="w-64 bg-slate-300 p-6 shadow-xl">
